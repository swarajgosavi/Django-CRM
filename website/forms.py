...
class SignUpForm(UserCreationForm):
    email = forms.EmailField(label="", widget=forms.TextInput(attrs={'class':'form-contrl', 'placeholder':'Email Address'}))
    first_name = forms.CharField(label="", max_length=100, widget=forms.TextInput(attrs={'class':'form-contrl', 'placeholder':'First Name'}))
    last_name = forms.CharField(label="", max_length=100, widget=forms.TextInput(attrs={'class':'form-contrl', 'placeholder':'Last Name'}))
...
class AddRecordForm(forms.ModelForm):
    ...
    pincode = forms.CharField(required=True, widget=forms.TextInput(attrs={'placeholder':"Pincode", "class":"form-control"}), label="")
